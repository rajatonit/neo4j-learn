...
#     graph_documents,
#     include_source=True,  # link each node to the source document
#     baseEntityLabel=True,  # Assiian a additional entity label for each node it creates
# )
...
# Retriever
# create a retreiever that gonna be able to retrieve entities and it's own information
# kg.query(
#     "CREATE FULLTEXT INDEX entity IF NOT EXISTS FOR (e:__Entity__) ON EACH [e.id]")


# Extract entities from text
# will desciper what entities are in the text
...
# Who is Ceaser?
# In the year of 123 there was an emperor who did not like to ru
...
# print(vector_index.similarity_search_with_relevance_scores("Who is Aurelian?"))
